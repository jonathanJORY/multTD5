...
void display()
{
    ...
    // Étape 2 : Calcule l'inverse de la matrice modelview
    glm::mat4 inverseModelview = inverse(modelview);

    // Étape 3 : Transpose la matrice inverse
    glm::mat4 transposedInverse = transpose(inverseModelview);

    // Étape 4 : Extrait la partie supérieure gauche 3x3
